...
('ADMIN', 'admin01', 'adminpw', '관리자', 999999999, 'admin@test.com', 4, '운영자');

-- 3. 계좌 (account) 생성
INSERT INTO account (bank_name, account_no, bank_owner, user_id, main_status) VALUES
('농협은행', '35608802134234', '홍길동', 1, 'Y'),
('국민은행', '93800200592714', '김철수', 2, NULL),
('우리은행', '53454358123525', '이영희', 3, 'Y'),
('신한은행', '13513549534455', '박민수', 4, 'Y');
...
('이벤트 안내', '신규가입 이벤트 진행 중입니다.', 5);

-- 12. 문의 (inquiry)
INSERT INTO inquiry (inquiry_title, inquiry_content, user_id, admin_id) VALUES
('입찰 오류 문의', '입찰이 안돼요', 1, 5),
('포인트 환불 문의', '환불은 어떻게 하나요?', 2, 5);

-- 13. 신고 (report)
INSERT INTO report (report_at, report_content, report_status, category_id, auction_id, reporter_id, handler_id) VALUES
(NOW(), '허위 상품 같아요', 'N', 5, 1, 2, 5),
(NOW(), '사기 의심됩니다', 'N', 5, 2, 3, 5);

-- 14. 배송 (delivery)
INSERT INTO delivery (delivery_address, delivery_no, delivery_status, send_user_id, reciver_user_id, auction_id) VALUES
...
('U',805000, '입찰 시 포인트 차감', 1, 2, -619000);
...
-- 18. 알람 박스 (alaram_box)
INSERT INTO alarm_box (alarm_check, user_id, alarm_id, auction_id) VALUES
('N', 1, 1, 1),
('Y', 2, 2, 2),
('N', 3, 1, 2),
('Y', 1, 2, 1),
