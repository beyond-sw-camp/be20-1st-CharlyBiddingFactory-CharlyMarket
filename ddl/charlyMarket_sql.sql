CREATE TABLE auction_item (
	...
	user_id VARCHAR(20) NOT NULL COMMENT '경매 물품 판매자',
...
CREATE TABLE report (
	...
	reporter_id VARCHAR(20) NOT NULL COMMENT '신고를 하는 사람', -- user fk
	handler_id VARCHAR(20) NOT NULL COMMENT '신고를 처리하는 사람', -- user fk
